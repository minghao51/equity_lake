...
Usage:
    ...
    python -m scripts.generate_test_data --start-date 2023-01-01 --days 365
    python -m scripts.generate_test_data --markets us --num-tickers 50
"""
...
Examples:
  ...
  python -m scripts.generate_test_data --days 365

  # Generate data for specific date range
  python -m scripts.generate_test_data --start-date 2023-01-01 --end-date 2024-12-31

  # Generate data for US market only
  python -m scripts.generate_test_data --markets us_equity

  # Generate smaller dataset for testing
  python -m scripts.generate_test_data --days 30 --num-tickers 20

  # Generate data with different volatility
  python -m scripts.generate_test_data --volatility 0.05 --trend 0.001
        """
    )
