...
This script demonstrates how to query the Hive-partitioned Parquet data
...
Usage:
    python -m scripts.query_example
    python -m scripts.query_example --query top_gainers
    python -m scripts.query_example --date 2024-12-01
"""
...
Examples:
  ...
  # Run specific query
  python -m scripts.query_example --query top_volume

  # Query with parameters
  python -m scripts.query_example --query gainers_losers --days 14

  # Export results to CSV
  python -m scripts.query_example --query top_volume --output results.csv

  # Benchmark performance
  python -m scripts.query_example --query benchmark
        """
    )
