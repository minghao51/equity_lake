...
from equity_lake.domain.backtesting.utils import extract_field_from_maybe_multiindex
...
class BacktestEngine:
    ...
    Example:
        >>> from equity_lake.domain.backtesting import BacktestEngine
        >>> from equity_lake.domain.backtesting.strategy import SMACrossoverStrategy
        >>>
    ...
    def _extract_signal_matrices(self, signals: pd.DataFrame, tickers: list[str]) -> tuple[pd.DataFrame, pd.DataFrame]:
        ...
        from equity_lake.domain.backtesting.vector_engine import extract_signal_matrices
