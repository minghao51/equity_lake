...
### 2. `src/equity_lake/config.py` (600+ lines)
...
### 3. `src/equity_lake/validators.py` (400+ lines)
...
### `src/equity_lake/ingest_daily.py` (1269 lines, was 637 lines)
**Changes:**
...
| `src/equity_lake/config.py` | 600+ | 0 | +600 |
| `src/equity_lake/validators.py` | 400+ | 0 | +400 |
| `src/equity_lake/ingest_daily.py` | 632 | 0 | +632 |
| `.env.example` | 31 | 0 | +31 |
| **Total** | **~2,363** | **0** | **+2,363** |
