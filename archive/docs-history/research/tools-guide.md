...
**Purpose**: Comprehensive guide to the technology stack used in the equity-lake project.
...
# Lint
ruff check src/equity_lake tests

# Auto-fix
ruff check --fix src/equity_lake tests

# Format
ruff format src/equity_lake tests
```
