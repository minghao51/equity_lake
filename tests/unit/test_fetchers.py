...
class TestCNEfinanceFetcher:
    ...
    def test_initialization_requires_efinance(self):
        ...
        with patch('equity_lake.ingestion.sources.cn_efinance.efinance', None):
            with pytest.raises(ImportError, match="efinance is not installed"):
                CNEfinanceFetcher()
...
class TestCNHybridFetcher:
    ...
    def test_initialization_with_both_sources(self):
        ...
        with patch('equity_lake.ingestion.sources.cn_hybrid.CNEfinanceFetcher',
                   MagicMock):
    ...
    def test_fetch_uses_efinance_first(self, mock_akshare, mock_efinance,
                                       sample_ohlcv_data):
