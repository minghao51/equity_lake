"""
Unit tests for DuckDB query examples script.
"""
...
import pandas as pd
from scripts.query_example import (
    EquityDataDB,
    QueryExamples,
)
from scripts import US_EQUITY_DIR, CN_ASHARE_DIR, HK_SG_EQUITY_DIR
...
class TestEquityDataDB:
    ...
    def test_create_market_view(self, tmp_path, temp_partitioned_parquet):
        ...
        with patch('scripts.query_example.US_EQUITY_DIR', temp_partitioned_parquet):
...
class TestQueryExamples:
    ...
    @pytest.fixture
    def db_with_data(self, temp_partitioned_parquet):
...
class TestQueryPerformance:
    ...
    def test_query_performance_benchmark(self, db_with_data):
        ...
        from scripts.query_example import benchmark_queries
