...
- `cli/`: stable `equity` subcommands (`equity ingest`, `equity query`, `equity pipeline`, etc.)
...
- Historical flat-module names and one-off CLI entrypoint modules are unsupported.
