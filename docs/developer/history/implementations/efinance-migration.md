...
**Location**: `src/equity_lake/ingest_daily.py` (add to existing file)
...
**Location**: `src/equity_lake/ingest_daily.py` (new utility function)
...
**Location**: `src/equity_lake/backfill_data.py`
...
**CLI Interface**:
```bash
python -m equity_lake.backfill_data \
...
**Location**: `src/equity_lake/ingest_daily.py`
...
uv run equity-daily --markets cn --date 2024-12-01
```
...
# Edit src/equity_lake/ingest_daily.py
