...
- [ ] **Test Data Generator** (`src/equity_lake/generate_test_data.py`)
...
#### Tasks
- [ ] **SQL Query Templates** (`queries/*.sql`)
...
- [ ] **Python Query Examples** (`src/equity_lake/query_example.py`)
